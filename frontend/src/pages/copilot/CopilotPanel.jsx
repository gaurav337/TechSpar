    ...
    <div className="p-6 space-y-6">
      ...
      <div className="copilot-fade-up group">
        <div className="flex items-center gap-2.5 mb-2">
          ...
          <span className={cn("text-[11px] font-bold uppercase tracking-[0.15em]", monitorData?.last_answer_feedback ? "text-cyan-400/90" : "text-dim/40")}>Answer Evaluation</span>
        </div>
            ...
            <>
              ...
              {monitorData.uncovered_topics?.length > 0 && (
                <div className="mt-2 pt-2 border-t border-border/30">
                  <span className="text-[11px] text-dim/60 mr-1.5">Uncovered:</span>
      ...
      <div className="copilot-fade-up copilot-stagger-1 group">
        <div className="flex items-center gap-2.5 mb-2">
          ...
          <span className={cn("text-[11px] font-bold uppercase tracking-[0.15em]", hasData ? "text-violet-400/90" : "text-dim/40")}>Current Focus</span>
        </div>
        <div className="pl-[34px]">
          {hasData ? (
      ...
      <div className="copilot-fade-up copilot-stagger-2 group">
        <div className="flex items-center gap-2.5 mb-2">
          ...
          <span className={cn("text-[11px] font-bold uppercase tracking-[0.15em]", recommendedPoints.length > 0 ? "text-primary/90" : "text-dim/40")}>Key Answer Points</span>
        </div>
        <div className="pl-[34px]">
            ...
            <>
              ...
              {prepHint?.redirect_suggestion && (
                <div className="mt-3.5 pt-3 border-t border-border/30 text-[12px] leading-5 bg-primary/5 rounded-lg p-2.5">
                  <span className="font-bold text-primary/80 mr-2 uppercase tracking-wide text-[10px]">Redirection Suggestion</span>
      ...
      <div className="copilot-fade-up copilot-stagger-3 group">
        <div className="flex items-center gap-2.5 mb-2">
          ...
          <span className={cn("text-[11px] font-bold uppercase tracking-[0.15em]", (answerLoading || streamingAnswer) ? "text-green/90" : "text-dim/40")}>AI Suggested Answer</span>
          ...
          {answerLoading && !streamingAnswer ? (
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-green/65 font-medium pt-1 flex items-center gap-1.5">
                ...
                Answer Coach generating first token...
              </p>
            </div>
          ) : streamingAnswer ? (
      ...
      <div className="copilot-fade-up copilot-stagger-4 group">
        <div className="flex items-center gap-2.5 mb-2">
          ...
          <span className={cn("text-[11px] font-bold uppercase tracking-[0.15em]", children.length > 0 ? "text-amber-500/90" : "text-dim/40")}>Predicted Follow-up Questions</span>
        </div>
        <div className="pl-[34px]">
          {children.length > 0 ? (
        ...
        <>
          ...
          <div className="copilot-fade-up copilot-danger-glow group">
            <div className="flex items-center gap-2.5 mb-2">
              ...
              <span className="text-[11px] font-bold uppercase tracking-[0.15em] text-amber-400">Warning</span>
            </div>
            <div className="pl-[34px]">
