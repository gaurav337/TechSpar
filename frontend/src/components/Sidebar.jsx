...
const NAV_ITEMS = [
  ...
  { path: "/topic-drill", label: "Topic Drills", icon: Target },
  { path: "/resume-interview", label: "Resume Interview", icon: FileText },
  { path: "/job-prep", label: "JD Prep", icon: BriefcaseBusiness },
  { path: "/recording", label: "Recording Review", icon: Mic },
  { path: "/copilot", label: "Interview Copilot", icon: Brain },
  { path: "/knowledge", label: "Question Bank", icon: BookOpen },
  { path: "/graph", label: "Knowledge Graph", icon: GitFork },
      ...
      <TooltipProvider delayDuration={0}>
        ...
        <div className={cn("py-2 space-y-0.5", collapsed ? "px-2" : "px-3")}>
          <Tooltip>
            ...
            {collapsed && <TooltipContent side="right" sideOffset={8}>{theme === "dark" ? "Light Mode" : "Dark Mode"}</TooltipContent>}
          </Tooltip>
          ...
          <Tooltip>
            ...
            {collapsed && <TooltipContent side="right" sideOffset={8}>Expand Sidebar</TooltipContent>}
          </Tooltip>
        </div>
      </TooltipProvider>
    </aside>
